      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10 pt-48">
        ...
        <div className="flex items-center justify-center pt-4">
          <div className="flex items-center gap-3 px-4 py-2 bg-card/50 border border-border rounded-lg">
            ...
            <span className="text-sm font-mono text-primary tracking-wider">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</span>
            <button 
              className="text-muted-foreground hover:text-primary transition-colors"
              onClick={() => navigator.clipboard.writeText("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")}
              title="Copy CA"
            >
